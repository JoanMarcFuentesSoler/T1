...
T= 2.5                                  # Durada de T segons
fm=8000                                 # Freqüència de mostratge en Hz
fx2=4000                                # Freqüència de la sinusoide
A=4                                     # Amplitud de la sinusoide
PI=np.pi                                # Valor del número pi
L = int(fm * T)                         # Nombre de mostres del senyal digital
Tm2=1/fm                               # Període de mostratge
t2=Tm2*np.arange(2)                    # Vector amb els valors de la variable temporal, de 0 a T
x2 = A * np.cos(2 * PI * fx2 * t)       # Senyal sinusoidal
sf.write('so_exemple2.wav', x2, fm)     # Escriptura del senyal a un fitxer en format wav
